...
export default function UpdateModal({post,getPosts}) {
 ...
 headers: {
    ...
    const url = config.url+'/api/posts/'+post.id
        axios
        .patch(url, {
          title:title,
          body: body
 ...
 const onError = (errors, e) => console.log(errors, e);
  ...
  <div className="p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
        ...
        <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Update Post</h5>
  ...
  <p className="font-bold"> Post Updated</p>
</div>}
